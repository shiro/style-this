// /packages/vite/tests/correctness-1/a.tsx (/packages/vite/tests/correctness-1/entry.tsx): {"__global__export__", "__styleThis_expression_1", "css", "foo", "__styleThis_expression_2"}
"use strict";
...
// /packages/vite/tests/correctness-1/entry.tsx: {"comp", "b", "__styleThis_expression_11", "a1", "unrelated", "css", "st", "__styleThis_expression_6", "color", "s2", "mutate", "style", "__styleThis_expression_3", "mib", "a"}
"use strict";
...
unrelated.css = `background: none;
  ${a.foo.css}`;
const cssSourcemapData = [{className:'__styleThis_expression_11-abwhir',start:181,end:187},{className:'m-9ib41m',start:248,end:266},{className:'b-aj4l6b',start:282,end:296},{className:'__styleThis_expression_6-irk5mb',start:373,end:407},{className:'s1-gta3sx',start:425,end:452},{className:'__styleThis_expression_3-q74xyr',start:483,end:488},{className:'s2-3ctqjk',start:603,end:633},{className:'unrelated-5y7cxe',start:654,end:695}];
